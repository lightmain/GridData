...
def codec_specs() -> dict[str, CodecSpec]:
    return {
        ...
        "zstd_1": CodecSpec("zstd_1", Zstd(level=1), "Zstandard level 1"),
        "zstd_2": CodecSpec("zstd_2", Zstd(level=2), "Zstandard level 2"),
        "zstd_3": CodecSpec("zstd_3", Zstd(level=3), "Zstandard level 3"),
